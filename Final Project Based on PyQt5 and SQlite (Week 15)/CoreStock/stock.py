...
class StockPage(QWidget):
    ...
    def refresh_alert(self):
        ...
        if low:
            ...
            self.alert.setStyleSheet("background:#fef2f2; color:#dc2626; border:1px solid #fca5a5; border-radius:6px; padding:7px;")
        else:
            self.alert.setText("✓  All stock levels are fine")
            self.alert.setStyleSheet("background:#f0fdf4; color:#16a34a; border:1px solid #86efac; border-radius:6px; padding:7px;")
